...
$ANNOVAR_LIB/table_annovar.pl ${SAMPLE}_deepvariant_panel.avinput ${ANNOVAR_DB} -buildver hg19 -out ${SAMPLE}_deepvariant_panel -protocol refGene,cytoBand,avsnp147,dbnsfp30a,1000g2015aug_eur,cosmic68 -operation gx,r,f,f,f,f -nastring . -csvout -polish -otherinfo
